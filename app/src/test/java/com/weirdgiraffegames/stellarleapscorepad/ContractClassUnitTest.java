...
public class ContractClassUnitTest {
    ...
    public void inner_class_exists() throws Exception {
        Class[] innerClasses = GameLogContract.class.getDeclaredClasses();
    ...
    public void inner_class_members_correct() throws Exception {
        ...
        assertEquals("There should be exactly 28 String members in the inner class", 28, allFields.length);
